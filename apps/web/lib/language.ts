...
const frenchLandingTranslations: Record<string, string> = {
  ...
  "Shopify app approval required": "Approbation de l'application Shopify requise",
  "Shopify has not approved this app to access protected customer data.": "Shopify n'a pas approuvé cette application pour accéder aux données client protégées.",
  "Request protected customer data access in the Shopify Partner Dashboard, then select Reconnect with OAuth.": "Demandez l'accès aux données client protégées dans le tableau de bord partenaire Shopify, puis sélectionnez Reconnecter avec OAuth.",
  ...
  "Save the required setting before data can be ingested. Without it, this connection will ingest no data.": "Enregistrez le paramètre requis avant d'ingérer des données. Sans ce paramètre, cette connexion n'ingérera aucune donnée.",
  "OAuth identifies the provider account. Select the account after authorization when more than one is available.": "OAuth identifie le compte du fournisseur. Sélectionnez le compte après l'autorisation lorsque plusieurs comptes sont disponibles.",
  "Select an account": "Sélectionner un compte",
  "Select the provider account used for ingestion.": "Sélectionnez le compte du fournisseur utilisé pour l'ingestion.",
